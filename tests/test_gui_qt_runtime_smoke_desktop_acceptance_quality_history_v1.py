...
from media_manager.core.gui_qt_runtime_smoke_desktop_acceptance_quality import build_qt_runtime_smoke_desktop_acceptance_quality


def test_acceptance_quality_and_history_are_ready_for_clean_results() -> None:
    ...
    assert history["summary"]["entry_count"] == 2
    assert history["summary"]["accepted_count"] == 2
