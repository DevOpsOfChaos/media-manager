...
from media_manager.core.state import build_execution_journal, write_execution_journal
...
def test_write_execution_journal_writes_json_file(tmp_path: Path) -> None:
