...
from media_manager.core.gui_qt_runtime_smoke_desktop_acceptance_history_index import build_qt_runtime_smoke_desktop_acceptance_history_index
...
from media_manager.core.gui_qt_runtime_smoke_desktop_acceptance_regression import build_qt_runtime_smoke_desktop_acceptance_regression
from media_manager.core.gui_qt_runtime_smoke_desktop_acceptance_trend import build_qt_runtime_smoke_desktop_acceptance_trend


def test_regression_detects_previous_green_to_current_blocked() -> None:
    ...
    gate = build_qt_runtime_smoke_desktop_acceptance_gate(build_qt_runtime_smoke_desktop_acceptance_matrix(acceptance_input))
    history = build_qt_runtime_smoke_desktop_acceptance_history_index(sample_history())
    ...
    assert trend["summary"]["direction"] == "stable_accepting"
