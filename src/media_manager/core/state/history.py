...
def latest_history_entries_by_command(
    entries: list[WorkflowHistoryEntry],
    *,
    command_name: str | None = None,
    record_type: str | None = None,
    ...
    latest: dict[str, WorkflowHistoryEntry] = {}
...
def summarize_history_entries_by_command(
    entries: list[WorkflowHistoryEntry],
    *,
    command_name: str | None = None,
    record_type: str | None = None,
    ...
    created_at_after: str | None = None,
    created_at_before: str | None = None,
) -> dict[str, WorkflowHistoryCommandSummary]:
    filtered = filter_history_entries(
        entries,
        command_name=command_name,
        record_type=record_type,
    ...
    summaries: dict[str, WorkflowHistoryCommandSummary] = {}
    for key in sorted(grouped):
        ...
        summaries[key] = WorkflowHistoryCommandSummary(
