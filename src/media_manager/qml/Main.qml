...
ApplicationWindow {
    ...
    Popup {
        ...
        width: Math.min(root.width * 0.78, 900)
        height: Math.min(root.height * 0.75, 680)
        modal: true
        focus: true
        ...
        contentItem: ColumnLayout {
            ...
            RowLayout {
                Layout.fillWidth: true
                spacing: 8
                PrimaryButton { text: trKey("duplicate_detail_keep_selected"); onClicked: appState.keepSelectedDuplicateCandidate() }
                Button {
                    ...
                    StackLayout {
                        ...
                        CardPanel {
                            ColumnLayout {
                                ...
                                ListView {
                                    ...
                                    delegate: Label { text: modelData; color: "#E6EEF8"; font.pixelSize: 13; width: ListView.view.width; elide: Text.ElideMiddle }
                                }
                                RowLayout {
                                    Layout.fillWidth: true
                                    PrimaryButton { text: trKey("stage_sources_action"); onClicked: sourceFolderDialog.open() }
                                    Button {
                        ...
                        CardPanel {
                            ColumnLayout {
                                ...
                                spacing: 10
                                Label { text: appState.workflowStageTitle; color: "#F7FAFF"; font.pixelSize: 24; font.bold: true }
                                Label { text: appState.targetPath.length > 0 ? appState.targetPath : trKey("stage_target_empty"); color: appState.targetPath.length > 0 ? "#F7FAFF" : "#8FB0E1"; wrapMode: Text.WrapAnywhere; Layout.fillWidth: true; Layout.fillHeight: true }
                                RowLayout {
                                    Layout.fillWidth: true
                                    PrimaryButton { text: trKey("stage_target_action"); onClicked: targetFolderDialog.open() }
                                    Button {
                                        text: trKey("button_clear")
                                        hoverEnabled: true
                            ...
                            ColumnLayout {
                                ...
                                Repeater {
                                    ...
                                    delegate: Button {
                                        ...
                                        contentItem: Text { text: trKey("mode_" + modelData); color: "#F7FAFF"; horizontalAlignment: Text.AlignHCenter; verticalAlignment: Text.AlignVCenter; font.pixelSize: 14; font.bold: true }
                                    }
                                }
                            }
                        }
                            ...
                            ColumnLayout {
                                ...
                                CardPanel {
                                    ...
                                    ColumnLayout {
                                        ...
                                        Label { text: appState.summaryReadyForDryRun ? trKey("summary_ready_body") : trKey("summary_unresolved_body"); color: "#F7FAFF"; wrapMode: Text.WordWrap; Layout.fillWidth: true }
                                    }
                                }
                                    ...
                                    Repeater {
                                        ...
                                        delegate: CardPanel {
                                            ...
                                            ColumnLayout {
                                                ...
                                                anchors.margins: 10
                                                spacing: 4
                                                Label { text: modelData[0]; color: "#AFC1D9"; font.pixelSize: 12; wrapMode: Text.WordWrap; Layout.fillWidth: true }
                                                Label { text: modelData[1]; color: "#F7FAFF"; font.pixelSize: 18; font.bold: true }
                                            }
                                        }
                                    }
                                }
                                ...
                                CardPanel {
                                    ...
                                    ColumnLayout {
                                        ...
                                        Label { text: appState.dryRunRowsCountLabel; color: "#8FB0E1"; font.pixelSize: 12; font.bold: true; Layout.fillWidth: true }
                                        ColumnLayout {
                                            Layout.fillWidth: true
                                            spacing: 6
                                ...
                                CardPanel {
                                    ...
                                    ColumnLayout {
                                        ...
                                        Label { text: appState.executionRowsCountLabel; color: "#8FB0E1"; font.pixelSize: 12; font.bold: true; Layout.fillWidth: true }
                                        ColumnLayout {
                                            Layout.fillWidth: true
                                            spacing: 6
                                ...
                                RowLayout {
                                    Layout.fillWidth: true
                                    Item { Layout.fillWidth: true }
                                    PrimaryButton { text: trKey("stage_summary_action"); enabled: appState.summaryReadyForDryRun; onClicked: appState.workflowNext() }
                                }
                            }
                        }
                        ...
                        ColumnLayout {
                            ...
                            CardPanel {
                                ...
                                ColumnLayout {
                                    ...
                                    Repeater {
                                        model: appState.duplicateRows
                                        delegate: Label { text: modelData.name + " • " + modelData.size; color: "#E6EEF8"; font.pixelSize: 12; wrapMode: Text.WordWrap; width: duplicatesManualColumn.width }
                                    }
                                }
                            }
                            CardPanel {
