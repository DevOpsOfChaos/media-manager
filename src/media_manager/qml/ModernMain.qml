                    ...
                    Flickable {
                        ...
                        ColumnLayout {
                            ...
                            Label {
                                ...
                                horizontalAlignment: Text.AlignHCenter
                                wrapMode: Text.WordWrap
                                Layout.preferredWidth: Math.min(parent.width * 0.78, 860)
                            }
                            ...
                            ColumnLayout {
                                Layout.alignment: Qt.AlignHCenter
                                Layout.preferredWidth: Math.min(parent.width * 0.72, 820)
                                spacing: 12
                                            ...
                                            Item {
                                                ColumnLayout {
                                                    ...
                                                    FramedChoiceButton {
                                                        ...
                                                        selected: appState.operationMode === "copy"
                                                    ...
                                                    FramedChoiceButton {
                                                        ...
                                                        selected: appState.operationMode === "move"
                                                    ...
                                                    FramedChoiceButton {
                                                        ...
                                                        selected: appState.operationMode === "delete"
